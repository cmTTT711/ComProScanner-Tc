...
def mock_paths(tmp_path, monkeypatch):
    ...
    with patch(
        "comproscanner.documents.prepare_iop.DefaultPaths",
...
def test_combine_xml_files(
    ...
    prep._check_body_presence = Mock(return_value=True)
...
@patch("comproscanner.documents.prepare_iop.PrepareIOPFiles._process_zip_files")
@patch("comproscanner.documents.prepare_iop.PrepareIOPFiles._combine_xml_files")
